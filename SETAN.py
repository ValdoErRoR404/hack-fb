...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN FACEBOOK DULU TOKE \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://m.youtube.com/watch?v=SG_XciMRcp8')
                time.sleep(2)
                menu()
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://m.facebook.com/valdo876?fref=nf')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
